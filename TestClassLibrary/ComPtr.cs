...
namespace TestClassLibrary
{
        ...
        where T : unmanaged
    {
        ...
        /// <remarks>
        /// This method will automatically release the target COM object pointed to by <paramref name="p"/>, if any.
        /// </remarks>
        public readonly HRESULT As<U>(ComPtr<U>* p)
            where U : unmanaged, IComIID
        {
            var iid = U.Guid;
            return ((IUnknown*)this.ptr_)->QueryInterface(&iid, (void**)p->ReleaseAndGetAddressOf());
        }
            ...
            where U : unmanaged, IComIID
        {
            U* ptr;
            var iid = U.Guid;
            var result = ((IUnknown*)this.ptr_)->QueryInterface(&iid, (void**)&ptr);
        ...
        /// <remarks>
        /// This method will release the current raw pointer, if any, but it will not increment the references for <paramref name="other"/>.
        /// </remarks>
        public void Attach(T* other)
        {
            if (this.ptr_ != null)
            {
                _ = ((IUnknown*)this.ptr_)->Release();
            }
        ...
        {
            this.InternalAddRef();
            *p->ReleaseAndGetAddressOf() = this.ptr_;
            return HRESULT.S_OK;
        }
        ...
        {
            var iid = U.Guid;
            return ((IUnknown*)this.ptr_)->QueryInterface(&iid, (void**)ptr);
        }
        ...
        {
            return ((IUnknown*)this.ptr_)->QueryInterface(riid, ptr);
        }
        ...
        {
            return ((IUnknown*)this.ptr_)->QueryInterface(riid, (void**)p->ReleaseAndGetAddressOf());
        }
        ...
        {
            IUnknown* ptr;
            var result = ((IUnknown*)this.ptr_)->QueryInterface(riid, (void**)&ptr);
